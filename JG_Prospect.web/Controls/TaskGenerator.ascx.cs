...
namespace JG_Prospect.Sr_App.Controls
{
    public partial class TaskGenerator : System.Web.UI.UserControl
    {
        ...
        protected void btnSaveTask_Click(object sender, EventArgs e)
        {
            ...
            if (this.lstSubTasks.Any())
            {
                foreach (Task objSubTask in this.lstSubTasks)
                {
                    ...
                    hdnSubTaskId.Value = TaskGeneratorBLL.Instance.SaveOrDeleteTask(objSubTask, 0,0).ToString();
        ...
        private void SaveTask()
        {
            ...
            Int64 ItaskId = TaskGeneratorBLL.Instance.SaveOrDeleteTask(task, 0,0);    // save task master details
        ...
        private void SaveSubTask()
        {
            ...
            {
                // save task master details to database.
                Int64 ItaskId = TaskGeneratorBLL.Instance.SaveOrDeleteTask(task, 0,0);
